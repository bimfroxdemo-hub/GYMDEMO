      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {trainers.map((trainer, index) => (
            <div
              key={index}
              className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:border-green-500 hover:shadow-xl hover:shadow-green-300 transition-all duration-300 group flex flex-col"
            >
              {/* IMAGE SECTION */}
              ...
              <div className="p-5 text-center flex-1 flex flex-col justify-between">
                ...
                <button
                  ...
                  className="flex items-center justify-center w-full py-2 px-4 bg-gray-400 hover:bg-green-400 text-white font-medium rounded-md transition-colors duration-300 mt-2"
                >
                  <IoLogoWhatsapp className="w-5 h-5 mr-2 text-green-500" />
                  Chat Now
                </button>
              </div>
            </div>
