    ...
    <section className='py-16 px-4 bg-gray-50'>
        <div className='max-w-6xl mx-auto'>
            ...
            <div className='text-center'>
                <h2 className='text-4xl md:text-5xl font-extrabold'>WEEKLY <span className='text-4xl md:text-5xl text-green-500'>SCHEDULE</span></h2>
            ...
            <div className='grid lg:grid-cols-3 sm:grid-cols-2 gap-8 mt-10'>
                {schedule.map((day,index) => (
                    <div 
                        key={index}
                        className='bg-white border border-gray-200 p-6 rounded-xl shadow-md  hover:border-green-300 hover:shadow-xl hover:shadow-green-300 transition-all duration-300 group'
                    >
